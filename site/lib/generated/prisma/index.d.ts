...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "account" | "session" | "verificationToken" | "authenticator" | "pixKey"
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "emailVerified" | "image" | "balance" | "role" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export type PixKeyOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"userId" | "key" | "type", ExtArgs["result"]["pixKey"]>
  ...
  export interface PixKeyDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `userId`
     * const pixKeyWithUserIdOnly = await prisma.pixKey.findMany({ select: { userId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many PixKeys and only return the `userId`
     * const pixKeyWithUserIdOnly = await prisma.pixKey.createManyAndReturn({
     *   select: { userId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more PixKeys and only return the `userId`
     * const pixKeyWithUserIdOnly = await prisma.pixKey.updateManyAndReturn({
     *   select: { userId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  export type PixKeyWhereUniqueInput = Prisma.AtLeast<{
    userId_key?: PixKeyUserIdKeyCompoundUniqueInput
    AND?: PixKeyWhereInput | PixKeyWhereInput[]
    OR?: PixKeyWhereInput[]
    NOT?: PixKeyWhereInput | PixKeyWhereInput[]
    userId?: StringFilter<"PixKey"> | string
  ...
  export type PixKeyUserIdKeyCompoundUniqueInput = {
    userId: string
    key: string
  }
